...
import { vehicleColumns } from '@/app/pages/dashboard/ecommerce/vehicles/components/vehicle-columns';
...
export function VehicleTable({ data, onRefresh }: VehicleTableProps) {
  ...
  return (
    <div className="space-y-4">
      <VehicleTableToolbar table={table} onRefresh={onRefresh} />
