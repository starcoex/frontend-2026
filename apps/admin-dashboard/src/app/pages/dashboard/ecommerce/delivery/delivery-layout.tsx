...
const PATH_TO_CONFIG_MAP: Record<string, BreadcrumbConfig> = {
  ...
  [DELIVERY_ROUTES.DRIVERS_CREATE]: DELIVERY_BREADCRUMB_CONFIGS.DRIVERS_CREATE,
  [DELIVERY_ROUTES.TRACKING]: DELIVERY_BREADCRUMB_CONFIGS.TRACKING,
  [DELIVERY_ROUTES.SETTLEMENTS]: DELIVERY_BREADCRUMB_CONFIGS.SETTLEMENTS, // ✅ 신규
  [DELIVERY_ROUTES.PRICING]: DELIVERY_BREADCRUMB_CONFIGS.PRICING, // ✅ 신규
};
