...
export const SERVICES_CONFIG: ServiceConfig[] = [
  {
    ...
    icon: Fuel,
    href: 'https://staroil.starcoex.co.kr', // 독립 앱의 소개/홈 페이지
    appHref: 'https://staroil.starcoex.co.kr/app', // 독립 앱의 실제 기능
    color: {
  ...
  },
  {
    ...
    icon: Truck,
    href: 'https://delivery.starcoex.co.kr', // 독립 앱의 소개/홈 페이지
    appHref: 'https://delivery.starcoex.co.kr/app', // 독립 앱의 실제 기능
    color: {
    ...
    available: true,
    isExternalApp: true,
    domain: 'delivery.starcoex.co.kr',
    order: 2,
    whyUseApp:
  ...
  },
  {
    ...
    detailDescription:
      '기본·별표·반짝반짝 3단계 외부 손세차로 차량을 빠르고 깨끗하게 관리합니다. 세차전용카드 결제 시 적립 혜택까지!',
    icon: Car,
    href: 'https://zeragae.starcoex.co.kr', // 독립 앱의 소개/홈 페이지
    appHref: 'https://zeragae.starcoex.co.kr/app', // 독립 앱의 실제 기능
    color: {
  ...
  },
  {
    ...
    icon: ShieldCheck,
    href: 'https://zeragae.starcoex.co.kr', // 독립 앱의 소개/홈 페이지 (출시 예정)
    appHref: 'https://zeragae.starcoex.co.kr/app', // 독립 앱의 실제 기능 (출시 예정)
    color: {
    ...
    features: ['코팅 서비스', '광택 서비스', '실내 크리닝', '디테일링 서비스'],
    available: true,
    comingSoon: false,
    isExternalApp: true,
    domain: 'zeragae.starcoex.co.kr',
